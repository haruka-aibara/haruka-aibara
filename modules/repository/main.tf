...
resource "github_repository" "this" {
  ...
  # generate-dev-io-summary repositories be destroyed for real (all were
  # absorbed into this monorepo with their history). This affects every repository this module manages,
